{% include "pos_zaviago/pos_zaviago/page/posapp/onscan.js" %}
frappe.pages['posapp'].on_page_load = function (wrapper) {
	...
	$("head").append("<link href='/assets/pos_zaviago/node_modules/vuetify/dist/vuetify.min.css' rel='stylesheet'>");
