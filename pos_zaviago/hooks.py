...
app_name = "pos_zaviago"
app_title = "POSZaviago"
app_publisher = "davil"
app_description = "POSZaviago"
...
# app_include_css = "/assets/pos_zaviago/css/pos_zaviago.css"
# app_include_js = "/assets/pos_zaviago/js/pos_zaviago.js"
app_include_js = [
    "/assets/pos_zaviago/node_modules/vuetify/dist/vuetify.js",
    "pos_zaviago.bundle.js",
]
# include js, css files in header of web template
# web_include_css = "/assets/pos_zaviago/css/pos_zaviago.css"
# web_include_js = "/assets/pos_zaviago/js/pos_zaviago.js"

# include custom scss in every website theme (without file extension ".scss")
# website_theme_scss = "pos_zaviago/public/scss/website"

# include js, css files in header of web form
# webform_include_js = {"doctype": "public/js/doctype.js"}
# webform_include_css = {"doctype": "public/css/doctype.css"}
doctype_js = {
    "POS Profile": "pos_zaviago/api/pos_profile.js",
    "Sales Invoice": "pos_zaviago/api/invoice.js",
    "Company": "pos_zaviago/api/company.js",
}
# include js in page
...
after_uninstall = "pos_zaviago.uninstall.after_uninstall"

# Svg Icons
# ------------------
# include app icons in desk
# app_include_icons = "pos_zaviago/public/icons.svg"

# Home Pages
# ----------
doc_events = {
    "Sales Invoice": {
        "validate": "pos_zaviago.pos_zaviago.api.invoice.validate",
        "before_submit": "pos_zaviago.pos_zaviago.api.invoice.before_submit",
        "before_cancel": "pos_zaviago.pos_zaviago.api.invoice.before_cancel",
    },
    "Customer": {
        "validate": "pos_zaviago.pos_zaviago.api.customer.validate",
        "after_insert": "pos_zaviago.pos_zaviago.api.customer.after_insert",
    },
}
...
# jinja = {
# 	"methods": "pos_zaviago.utils.jinja_methods",
# 	"filters": "pos_zaviago.utils.jinja_filters"
# }

# Installation
# ------------

# before_install = "pos_zaviago.install.before_install"
# after_install = "pos_zaviago.install.after_install"

# Uninstallation
# ------------

# before_uninstall = "pos_zaviago.uninstall.before_uninstall"
# after_uninstall = "pos_zaviago.uninstall.after_uninstall"
...
# before_app_install = "pos_zaviago.utils.before_app_install"
# after_app_install = "pos_zaviago.utils.after_app_install"
...
# before_app_uninstall = "pos_zaviago.utils.before_app_uninstall"
# after_app_uninstall = "pos_zaviago.utils.after_app_uninstall"

# Desk Notifications
# ------------------
# See frappe.core.notifications.get_notification_config

# notification_config = "pos_zaviago.notifications.get_notification_config"
...
# scheduler_events = {
# 	"all": [
# 		"pos_zaviago.tasks.all"
# 	],
# 	"daily": [
# 		"pos_zaviago.tasks.daily"
# 	],
# 	"hourly": [
# 		"pos_zaviago.tasks.hourly"
# 	],
# 	"weekly": [
# 		"pos_zaviago.tasks.weekly"
# 	],
# 	"monthly": [
# 		"pos_zaviago.tasks.monthly"
# 	],
# }
fixtures = [
    {
...
# before_tests = "pos_zaviago.install.before_tests"

# Overriding Methods
# ------------------------------
#
# override_whitelisted_methods = {
# 	"frappe.desk.doctype.event.event.get_events": "pos_zaviago.event.get_events"
# }
#
...
# 	"Task": "pos_zaviago.task.get_dashboard_data"
# }
...
# Request Events
# ----------------
# before_request = ["pos_zaviago.utils.before_request"]
# after_request = ["pos_zaviago.utils.after_request"]

# Job Events
# ----------
# before_job = ["pos_zaviago.utils.before_job"]
# after_job = ["pos_zaviago.utils.after_job"]
