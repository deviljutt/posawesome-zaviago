...
export default {
  ...
  methods: {
    ...
    submit_invoice(print) {
      ...
      const vm = this;
      frappe.call({
        method: "pos_zaviago.pos_zaviago.api.posapp.submit_invoice",
        args: {
          data: data,
    ...
    get_available_credit(e) {
      ...
      if (e) {
        frappe
          .call("pos_zaviago.pos_zaviago.api.posapp.get_available_credit", {
    ...
    get_addresses() {
      ...
      frappe.call({
        method: "pos_zaviago.pos_zaviago.api.posapp.get_customer_addresses",
    ...
    get_sales_person_names() {
      ...
      frappe.call({
        method: "pos_zaviago.pos_zaviago.api.posapp.get_sales_person_names",
        callback: function (r) {
          if (r.message) {
    ...
    request_payment() {
      ...
      frappe
        ...
        .then(() => {
          frappe
            .call({
              method: "pos_zaviago.pos_zaviago.api.posapp.create_payment_request",
              args: {
                doc: vm.invoice_doc,
              },
            })
    ...
    get_mpesa_modes() {
      const vm = this;
      frappe.call({
        method: "pos_zaviago.pos_zaviago.api.m_pesa.get_mpesa_mode_of_payment",
